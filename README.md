...
The investigation focuses on tracking the movement of funds across multiple intermediary wallets, identifying obfuscation techniques such as transaction layering and fanning, and documenting findings in a formal forensic style report.

## Objectives
- Trace Bitcoin transactions across multiple hops using public blockchain explorers
- Identify patterns consistent with laundering, obfuscation, and fund layering
- Apply threat modeling and vulnerability analysis to financial transaction flows
- Document investigative methodology, findings, and limitations in a professional report
- Analyze multiple Bitcoin transaction patterns including layered transfer chains and high value fan-out distributions
- Compare how different transaction structures impact traceability and cyber risk
